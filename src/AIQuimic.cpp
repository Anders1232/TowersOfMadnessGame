...
AIQuimic::AIQuimic(float speed, int dest, TileMap<Tile>& tileMap, GameObject &associated,WaveManager& wManager)
	:Component(associated),
	 ...
	 shooter(new Shooter(associated, (NearestFinder<GameObject>*) ( (StageState*)( &(Game::GetInstance().GetCurrentState()) ) ),
	 					 (Finder<GameObject>*)(finder), GameComponentType::TOWER, 500000, 2.5,
