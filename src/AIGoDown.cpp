...
AIGoDown::AIGoDown(float speed, int dest, TileMap<Tile>& tileMap, WaveManager &wManager, GameObject &associated):speed(speed),destTile(dest),tileMap(tileMap), waveManager(wManager), associated(associated), Component(associated){
}
