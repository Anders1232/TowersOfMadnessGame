...
AIGoDown::AIGoDown(float speed, int dest, TileMap<Tile>& tileMap, WaveManager &wManager, GameObject &associated):Component(associated),speed(speed),destTile(dest),tileMap(tileMap), waveManager(wManager), associated(associated){
}
