...
Tower::Tower(TowerType type, Vec2 pos, Vec2 tileSize, int hp,GameObject& associated):Component(associated){
	...
	NearestFinder<GameObject>* stageState = (NearestFinder<GameObject>*) ( (StageState*)( &(Game::GetInstance().GetCurrentState()) ) );

	switch(type){
		case TowerType::SMOKE:
			finder = new NearestComponentFinder(GameComponentType::ENEMY, associated.box.Center());
			associated.AddComponent(new Aura(associated, Enemy::Event::SMOKE, 400, 7.0, stageState, (Finder<GameObject>*)(finder)));
			break;
		case TowerType::ANTIBOMB:
			finder = new NearestComponentFinder(GameComponentType::BULLET, associated.box.Center());
			associated.AddComponent(new Shooter(associated, stageState, (Finder<GameObject>*)(finder), GameComponentType::BOMB, 5000, 2.0, Shooter::TargetPolicy::ALWAYS_NEAREST, true, 500, 5000, "img/SpriteSheets/anti-bomba_idle.png", 11, 1));
			break;
		case TowerType::STUN:
			finder = new NearestComponentFinder(GameComponentType::ENEMY, associated.box.Center());
			associated.AddComponent(new Aura(associated, Enemy::Event::STUN, 400, 7.0, stageState, (Finder<GameObject>*)(finder)));
			break;
		case TowerType::SHOCK:
			finder = new NearestComponentFinder(GameComponentType::ENEMY, associated.box.Center());
			associated.AddComponent(new Shooter(associated, stageState, (Finder<GameObject>*)(finder), GameComponentType::ENEMY, 5000, 2.0, Shooter::TargetPolicy::ALWAYS_NEAREST, true, 1500, 5000, "img/SpriteSheets/bullet_choquelvl1.png", 4, 1));
			break;
