...
AIEngineer::AIEngineer(float speed,int dest,TileMap<BaseTile>& tilemap, GameObject &associated,WaveManager& wManager):speed(speed),destTile(dest), pathIndex(0),tileMap(tilemap),associated(associated),waveManager(wManager){
