...
AIMedic::AIMedic(float speed,int dest,TileMap<Tile>& tilemap,GameObject &associated,WaveManager &wManager):speed(speed),destTile(dest), pathIndex(0),tileMap(tilemap),associated(associated),waveManager(wManager){
